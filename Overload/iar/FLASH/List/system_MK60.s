...
//    Locale       =  C
//    List file    =  
//        D:\workspace\LPLD_OSKinetis_V3\project\Overload3\iar\FLASH\List\system_MK60.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   65               | SIM_SCGC5_PORTE_MASK );
        LDR.N    R4,??DataTable1  ;; 0x40048038
        LDR      R0,[R4, #+0]
        ORR      R0,R0,#0x3E00
        STR      R0,[R4, #+0]
//   66 #if (DISABLE_WDOG)
...
//   69   WDOG->UNLOCK = (uint16_t)0xC520u;     /* Key 1 */
        LDR.N    R0,??DataTable1_1  ;; 0x40052000
        MOVW     R1,#+50464
        STRH     R1,[R0, #+14]
...
//   94   term_port_structure.UART_Uartx = TERM_PORT;
        LDR.N    R0,??DataTable1_7  ;; 0x400eb000
        STR      R0,[SP, #+12]
...
SystemCoreClockUpdate:
        LDR.N    R1,??DataTable1_8  ;; 0x40064004
        LDRB     R2,[R1, #+1]
        AND      R2,R2,#0x1F
        ADDS     R2,R2,#+24
        LDR.N    R0,??DataTable1_9  ;; 0x2faf080
        MULS     R2,R0,R2
