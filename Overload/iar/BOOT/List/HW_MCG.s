...
//    Command line =  
//        -f C:\Users\JoyC\AppData\Local\Temp\EWCE05.tmp
...
//    Locale       =  C
//    List file    =  
//        D:\workspace\LPLD_OSKinetis_V3\project\Overload\iar\BOOT\List\HW_MCG.s
//
///////////////////////////////////////////////////////////////////////////////
...
??LPLD_PLL_Setup_19:
        MOVS     R0,#+0
        LDR.W    R12,??LPLD_PLL_Setup_0  ;; 0x40064001
        STRB     R0,[R12, #+0]
//  236   // @@@@@@@@@,@@@@@@@@ oscillator @ GPIO 
...
//  248   MCG->C5 = MCG_C5_PRDIV(prdiv); // @@ PLL @@@@@@@@@@ 
        ANDS     R7,R7,#0x1F
        LDR.N    R0,??LPLD_PLL_Setup_0+0x14  ;; 0x40064004
        STRB     R7,[R0, #+0]
//  249   // @@MCG_C6@@@@@@,@@LOLIE@PLL@@@@@@@,@PLL VCO@@@
//  250   MCG->C6 = 0x0;
        MOVS     R0,#+0
        LDR.N    R7,??LPLD_PLL_Setup_0+0x18  ;; 0x40064005
        STRB     R0,[R7, #+0]
//  251   //@@@@@@@@@@
...
//  254   MCG->C6 = MCG_C6_PLLS_MASK | MCG_C6_VDIV(vdiv); 
        ANDS     R5,R5,#0x1F
        ORRS     R5,R5,#0x40
        LDR.N    R0,??LPLD_PLL_Setup_0+0x18  ;; 0x40064005
        STRB     R5,[R0, #+0]
...
//  259   MCG->C1 &= ~MCG_C1_CLKS_MASK;
        LDR.N    R0,??LPLD_PLL_Setup_0+0xC  ;; 0x40064000
        LDRB     R0,[R0, #+0]
        ANDS     R0,R0,#0x3F
        LDR.N    R1,??LPLD_PLL_Setup_0+0xC  ;; 0x40064000
        STRB     R0,[R1, #+0]
